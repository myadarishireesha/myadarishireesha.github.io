...
<img src="/assets/assault_calplot.png" alt="Crime Plot" width="700" style="border:1px solid #ccc; border-radius:5px;">
...
# Top 5 Focus Crimes
<img src="/assets/monthly_stacked_top5.html" width="500" style="border:1px solid #ccc; border-radius:5px;">
<img src="/assets/assault_hourly.png" alt="Crime Plot" width="500" style="border:1px solid #ccc; border-radius:5px;">
